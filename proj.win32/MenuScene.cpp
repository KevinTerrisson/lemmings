...
bool MenuScene::init() {
    ...
    startMenu = MenuItemImage::create("start-game.png", "start-game-seclected.png", CC_CALLBACK_1(MenuScene::changeScene, this));
    exitMenu = MenuItemImage::create("start-game.png", "start-game-seclected.png", CC_CALLBACK_1(MenuScene::exitGame, this));
